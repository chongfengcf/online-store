            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    ...
                    <li class="am-text-sm tpl-header-navbar-welcome">
                        <a href="javascript:;">欢迎你, <span><%=session.getAttribute("sysusername")%></span> </a>
                    </li>
    ...
    <div class="left-sidebar">
        ...
        <div class="tpl-sidebar-user-panel">
            <div class="tpl-user-panel-slide-toggleable">
              ...
              <%=session.getAttribute("sysusername")%>
          </span>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form" action="${pageContext.request.contextPath}/sys/user/update" method="post">
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">账号 <span class="tpl-form-line-small-title">loginName</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="loginName" class="tpl-form-input" placeholder="请输入文字" value="${item.loginName}">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="password" name="passWord" class="tpl-form-input" value="${item.passWord}">
                                        <small>请填写文字10-20字左右。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="name" class="tpl-form-input" placeholder="请输入文字" value="${item.name}">
                                        <small>请填写文字10-20字左右。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select id="selectsex" name="sex" data-am-selected="{searchBox: 1}" style="display: none;">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="email" name="email" class="tpl-form-input" value="${item.email}">
                                        <small>请填写文字10-20字左右。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="tel" name="phone" step="1" min="1" max="99999" class="tpl-form-input" value="${item.phone}">
                                        <small>输入手机号码</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="address" placeholder="输入地址" value="${item.address}">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select id="selectrole" name="role" data-am-selected="{searchBox: 1}" style="display: none;">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="active" placeholder="状态" value="${item.active}">
                                    </div>
                                </div>
